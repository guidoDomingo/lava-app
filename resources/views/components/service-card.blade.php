...
<article {{ $attributes->merge(['class' => 'group rounded-3xl bg-white p-7 ring-1 ring-slate-100 transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-sky-900/5']) }}>
 <div class="mb-8 flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-600 transition group-hover:bg-sky-600 group-hover:text-white"><x-icon :name="$icon" class="h-6 w-6" /></div>
